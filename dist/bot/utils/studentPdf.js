...
exports.buildStudentPdf = void 0;
const pdfkit_1 = __importDefault(require("pdfkit"));
const formatTitle = (info) => `EduManage — Student Report (${info.studyYearName})`;
const safe = (value) => value.replace(/\s+/g, " ").trim();
const writeKeyValue = (doc, key, value) => {
    doc.font("Helvetica-Bold").text(`${key}: `, { continued: true });
    doc.font("Helvetica").text(value);
};
const buildStudentPdf = (info) => new Promise((resolve, reject) => {
...
exports.buildStudentPdf = buildStudentPdf;
